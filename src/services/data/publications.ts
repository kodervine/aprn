import { EPublicationType } from '../types/publications';
    ...
    items: [
      {
        ...
        authors: 'Mathias Chukwudi Isiani',
        summary:
      ...
      },
      {
        ...
        authors:
          'Mathias Chukwudi Isiani, Lovelyn Isiani, Ngozika Obi-Ani, Paul Obi-Ani, Alexander Chukwuemeka Isiani, Juliet Isiani',
        summary:
          'This research critically examines the post-civil war Igba-boi apprenticeship system, unveiling its pivotal role in shaping Onitsha into a thriving urban economic hub through robust human capital development. The apprenticeship system forged between a trader-mentor and a mentee over a specific timeframe act as a conduit for passing on trade expertise...',
        date: 'June, 2024',
        publisher: 'Cities',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        authors: 'Odinaka Eze, Mathias Isiani, Ngozika Obi-Ani',
        summary:
    ...
    items: [
      {
        ...
        authors:
          'Ngozika Obi-Ani, Chinenye Anikwenze, Mathias Chukwudi Isiani, ',
        summary:
        ...
        date: 'July, 2020',
        publisher: 'Cogent Arts and Humanities',
        type: EPublicationType.Article,
