import { coreTeamResearchers } from '@/services/data/people';
  ...
  return (
    <div className="min-h-screen py-16 px-6">
      ...
      <p className="text-lg text-center mt-4">
        Meet the scholars at the forefront of uncovering African and diaspora
        histories.
      </p>

      <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8 md:px-24">
        {coreTeamResearchers.map((researcher, index) => (
          <div
            key={index}
